...
class CsvWriterConan(ConanFile):
    """Class to package the CsvWriter plugin using conan

    Packages both RELEASE and DEBUG.
    Uses rules_support (github.com/ManiVaultStudion/rulessupport) to derive
    versioninfo based on the branch naming convention
    as described in https://github.com/ManiVaultStudio/core/wiki/Branch-naming-rules
    """

    name = "CsvWriterPlugin"
    description = "Write CSV encoded data from the ManiVault framework. "
    topics = ("ManiVault", "plugin", "data", "csv write")
    url = "https://github.com/ManiVaultStudio/CsvWriter"
    ...
    scm = {
        "type": "git",
        "subfolder": "ManiVaultStudio/CsvWriter",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="ManiVaultStudio/CsvWriter")
        cmake.verbose = True
        return cmake
    ...
    def build(self):
        ...
        # The CsvWriter build expects the HDPS package to be in this install dir
